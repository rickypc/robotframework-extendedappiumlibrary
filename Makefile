...
version:
	grep "VERSION = '*'" src/ExtendedAppiumLibrary/version.py	
...
testpypi_upload:documentation
	...
	@echo https://testpypi.python.org/pypi/robotframework-extendedappiumlibrary/

pypi_upload:documentation
	python setup.py sdist upload -r pypi --sign
	@echo https://pypi.python.org/pypi/robotframework-extendedappiumlibrary/
